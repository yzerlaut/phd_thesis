#+TITLE: Modeling population dynamics in neocortical networks: a bottom-up approach
#+AUTHOR: Yann Zerlaut
#+DATE: PhD Thesis
...
connectivité façonnent la dynamique de population de réseaux neuronaux
dans le néocortex. Nous commençons donc par présenter les concepts
physiologiques
...
** _Work 4_: Spatio-temporal dynamics of multi-input integration in primary visual cortex: comparison between a /mean-field/ model  and of the cortical sheet
...
*** Modulation of sensory response by network state
