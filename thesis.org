...
* Single cell computation in the asynchronous state of cortical networks :noexport:
...
* Population dynamics during sensory processing :noexport:
...
#+LATEX_CLASS: report
# #+OPTIONS: num: 3
#+LaTeX_CLASS_OPTIONS: [twoside, colorlinks]
